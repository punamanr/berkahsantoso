...
======================================================-->
    <div class="container">
        <div class="row title-bar">
          <div class="col-md-12">
            <h1 class="wow fadeInUp">Our Client Thoughts</h1>
    ...
    <section id="testimonials-p1" class="bg-parallax testimonials-p1-bg">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-4 bg-gradiant testimonials-p1-pos">
            <div class="testimonials-p1-cont">
              <div id="customers-testimonials" class="text-center owl-carousel owl-theme">
                <div class="testimonial">
                    <img src="img/client/avatar-2.jpg" alt="testimonial" class="img-fluid rounded-circle">
                    <blockquote>
                ...
                <div class="testimonial">
                    <img src="img/client/avatar-6.jpg" alt="testimonial" class="img-fluid rounded-circle">
                    <blockquote>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed veniam, unde sit, non quasi quia qui maiores odit voluptas voluptatem rem mollitia nemo est voluptates soluta ullam quis a velit.</p>
                    </blockquote>
                    <div class="testimonial-author">
                ...
                <div class="testimonial">
                    <img src="img/client/avatar-1.jpg" alt="testimonial" class="img-fluid rounded-circle">
                    <blockquote>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed veniam, unde sit, non quasi quia qui maiores odit voluptas voluptatem rem mollitia nemo est voluptates soluta ullam quis a velit.</p>
                    </blockquote>
                    <div class="testimonial-author">
    ...
    <section id="client" class="client testimonials-p2">
      <div class="container"> 
        <div class="row">
          ...
          <div class="col-md-6 col-sm-12">
            <div class="client-cont">
              <img src="img/client/avatar-1.jpg" class="img-fluid" alt="">
              <h5>John Doso</h5>
              <h6>DSS CEO & Cofounder</h6>
              <i class="fa fa-quote-left"></i>
              <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece.</p>
          ...
          <div class="col-md-6 col-sm-12">
            <div class="client-cont">
              <img src="img/client/avatar-3.jpg" class="img-fluid" alt="">
              <h5>Leesa len</h5>
              <h6>DSS CEO & Cofounder</h6>
              <i class="fa fa-quote-left"></i>
              <p>The Businessbox service - it helps fill our Business, and increase our show up rate every single time.</p>
          ...
          <div class="col-md-6 col-sm-12">
            <div class="client-cont">
              <img src="img/client/avatar-4.jpg" class="img-fluid" alt="">
              <h5>Dec Bol</h5>
              <h6>TEMS founder</h6>
              <i class="fa fa-quote-left"></i>
              <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece.</p>
          ...
          <div class="col-md-6 col-sm-12">
            <div class="client-cont">
              <img src="img/client/avatar-5.jpg" class="img-fluid" alt="">
              <h5>John Doso</h5>
              <h6>DSS CEO & Cofounder</h6>
              <i class="fa fa-quote-left"></i>
              <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece.</p>
