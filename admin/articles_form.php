            ...
            <form method="post" action="model/services/update-services" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
                      <br>
                        <div class="form-group">
                            <label for="judulLayanan">Judul Artikel</label>
                        ...
                        <div class="form-group">
                            <label for="judulLayanan">Sumber Artikel</label>
                            <input type="text" class="form-control" name="sumber_artikel" maxlength="75" value="<?php echo $obj->sumber_artikel ?>">
                        </div>
                    ...
                    <div class="col-md-6">
                      <br>
                        <div class="form-group">
                            <label for="exampleInputFile">Gambar Profile Artikel</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                      <br>
                        ...
                        <div class="form-group">
                            <label for="judulLayanan">Sumber Artikel</label>
                            <input type="text" class="form-control" name="sumber_artikel" maxlength="75">
                        </div>
                        <fieldset class="form-group">
                            <label>Publikasikan</label>
                            <div class="form-check">
