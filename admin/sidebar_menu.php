...
<nav class="side-navbar">
    ...
    <ul class="list-unstyled">
        ...
        <li <?php if( basename($_SERVER['PHP_SELF'], '.php') == 'portofolio' ) { ?> class="active" <?php } else { ?> <?php }?>> <a href="portofolios"><i class="icon-website"></i>Portofolio</a></li>
        ...
        <li <?php if( basename($_SERVER['PHP_SELF'], '.php') == 'user' ) { ?> class="active" <?php } else { ?> <?php }?>><a href="medsos"><i class="fa fa-globe"></i> <span>Media Sosial</span></a></li> 
