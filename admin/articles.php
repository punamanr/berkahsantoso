                      ...
                      <table class="table table-hover responsive">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>                     
                              <center>
                                <a href="model/users/delete-artikel/<?php echo $row['id']?>/<?php echo $row['judul']?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin akan menghapus artikel ini?')">Hapus</a>
                               </center>
                            </td>
                          </tr>
                          <?php } ?>
